...
- [SN-REL-001](release.md#sn-rel-001) **Establish release engineering: versioning, pipelines, store submission and rollback** (epic · M8 Launch & Growth)
  ...
  - [SN-REL-013](release.md#sn-rel-013) **Write the release checklist and go/no-go runbook** · p1 · docs · M · M8 Launch & Growth
...
**Out:** the workflow that publishes them ([SN-REL-004](release.md#sn-rel-004), [SN-REL-005](release.md#sn-rel-005)); the listing metadata as a whole ([SN-REL-010](release.md#sn-rel-010)); translation of the notes ([SN-I18N-001](i18n.md#sn-i18n-001) supplies the locale process); the in-app What's new rendering ([SN-REL-016](release.md#sn-rel-016)); and the docs-site publication of the changelog, the product-voice curation of the user-facing "what's new" entries and the DOC What's-new rendering - owned by [SN-DOC-012](docs.md#sn-doc-012), which consumes this generator. This issue owns the commit->artifacts generator (git-cliff config, CHANGELOG.md, store release notes, Security section + reporter credit, redaction, commit-lint).
...
| SDLC | release |
| Parent | [SN-REL-001](release.md#sn-rel-001) |
| Depends on | [SN-IPAD-024](ci-cd.md#sn-ipad-024), [SN-FND-005](devx.md#sn-fnd-005) |
...
#### Dependencies
[SN-IPAD-024](ci-cd.md#sn-ipad-024) (TestFlight pipeline), [SN-FND-005](devx.md#sn-fnd-005) (beta flavour). Beta uses TestFlight groups + Play closed tracks; the production track-promotion/staged-rollout automation [SN-REL-006](release.md#sn-rel-006) (M8) is referenced but not a scheduling blocker. Related: [SN-TEL-001](telemetry.md#sn-tel-001), [SN-A11Y-001](a11y.md#sn-a11y-001), [SN-PERF-004](perf.md#sn-perf-004).
...
| SDLC | release |
| Parent | [SN-REL-001](release.md#sn-rel-001) |
| Depends on | [SN-AUTH-005](auth.md#sn-auth-005), [SN-PRV-014](privacy.md#sn-prv-014), [SN-PRV-015](privacy.md#sn-prv-015), [SN-AND-021](compat.md#sn-and-021), [SN-AND-026](release.md#sn-and-026) |
...
#### Dependencies
[SN-AUTH-005](auth.md#sn-auth-005) (Sign in with Apple), [SN-PRV-014](privacy.md#sn-prv-014) (privacy manifest), [SN-PRV-015](privacy.md#sn-prv-015) (privacy declarations), [SN-AND-021](compat.md#sn-and-021) (16 KB alignment), [SN-AND-026](release.md#sn-and-026) (Play readiness). The subscription-disclosure check is wired when [SN-BILL-017](billing.md#sn-bill-017) (M8) lands; the M7 gate covers the privacy/Apple-sign-in/alignment items, so SN-BILL-017 is not a scheduling blocker. Consumed by [SN-REL-004](release.md#sn-rel-004).
